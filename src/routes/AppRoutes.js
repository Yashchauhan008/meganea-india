...
// Dashboard
import IndiaDashboardPage from '../pages/IndiaDashboardPage';
...
const AppRoutes = () => {
    ...
    const INDIA_ROLES = ['admin', 'Admin', 'india-staff', 'India Staff'];
                    ...
                    <ProtectedRoute roles={INDIA_ROLES}>
                        <SidebarLayout>
                            <Routes>
                                ...
                                <Route path="/dashboard" element={<IndiaDashboardPage />} />

                                {/* Tile Management */}
                                <Route path="/tiles" element={<TileListPage />} />
                                <Route path="/india-tiles" element={<TileListPage />} />
                                ...
                                <Route path="/loading-plans" element={<LoadingPlanListPage />} />
                                <Route path="/loading-plans/new" element={<CreateLoadingPlanPage />} />
                                <Route path="/loading-plans/create" element={<CreateLoadingPlanPage />} />
